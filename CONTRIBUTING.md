...
make smoke-wheel # build wheel + import from an isolated target dir
...
4. Add the section to `AppConfig` in `src/mysorf_base/config/core/schema.py`.
5. Wire into `bootstrap()` in `src/mysorf_base/runtime/core/bootstrap.py`.
...
Open an issue at https://github.com/mysorf-9239/mysorf-base/issues and include:

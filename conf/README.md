...
[`conf/`](./) is the Hydra configuration source for the `mysorf-base` library. Config groups are kept at the repository root
...
Logging configuration groups passed to `mysorf_base.logging`.
...
Tracking configuration groups passed to `mysorf_base.tracking`.
...
Profiling configuration groups passed to `mysorf_base.profiling`.
...
Artifacts configuration groups passed to `mysorf_base.artifacts`.
...
Sweeps configuration groups passed to `mysorf_base.sweeps`.
...
|--------------|-------------------------------------------------------|
| `logging/`   | [`mysorf_base.logging`](../src/mysorf_base/logging/README.md)     |
| `tracking/`  | [`mysorf_base.tracking`](../src/mysorf_base/tracking/README.md)   |
| `profiling/` | [`mysorf_base.profiling`](../src/mysorf_base/profiling/README.md) |
| `artifacts/` | [`mysorf_base.artifacts`](../src/mysorf_base/artifacts/README.md) |
| `sweeps/`    | [`mysorf_base.sweeps`](../src/mysorf_base/sweeps/README.md)       |

## Rules

- Secrets must not be committed to `conf/`. Use `oc.env` interpolation for credentials and let `mysorf_base.config` load
...
4. Implement the subsystem under `src/mysorf_base/`.

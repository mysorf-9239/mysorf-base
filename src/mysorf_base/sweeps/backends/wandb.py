...
class WandbRunner:
    ...
    def _build_sweep_config(self) -> dict[str, Any]:
        """Build the wandb sweep configuration from mysorf-base semantics."""
    ...
    def run(
        ...
        try:
            ...
            raise ImportError(
                "wandb is not installed. Install mysorf-base with the 'tracking-wandb' extra: "
                "pip install 'mysorf-base[tracking-wandb]'"
            ) from exc
